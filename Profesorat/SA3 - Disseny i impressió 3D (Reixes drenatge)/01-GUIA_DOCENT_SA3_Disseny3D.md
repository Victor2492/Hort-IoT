...
> Conté la planificació completa, configuració del software, gestió d'impressores, rúbriques i orientacions per a la implementació de la SA3.
...
| **CE2** | Fabricació digital (CAD, laminat, impressió 3D FDM) | **Molt alt** |
| **CE6** | Sostenibilitat (PLA bioplàstic, petjada ambiental, economia circular) | Mitjà |
...
### 2.4 Connexió amb la programació (SA4)

> La reixa incorpora el canal guia per al sensor d'humitat que s'usarà a la SA4. Això garanteix que la integració física (reixa) i la integració digital (sensor + Arduino) siguen coherents i planificades des del principi.
...
|--------|-------|----------------------|:-----:|----------|
| **S1** | La impressió 3D i el nostre repte | Presentació SA. Vídeo FDM. Observació impressora. Anàlisi requeriments reixa. Pluja d'idees. | CE1, CE6 | PPTX, impressora per observar |
| **S2** | Anàlisi de requeriments i esbós | Mesures caixó SA2. Disseny a mà alçada (3 vistes, cotes). Càlcul àrea drenatge. | CE1, CE3, CE5 | Fitxa disseny a mà, cinta mètrica |
| **S3** | Del 2D al 3D: conceptes | Eixos XYZ, sòlid/buit, toleràncies. Mesura peces impreses amb peu de rei. Introducció visual TinkerCAD. | CE1, CE5 | Peces 3D impreses (referència), peu de rei |
...
| **S12** | Proves funcionals i iteració | Instal·lar al caixó. 5 proves de validació. Identificar problemes. Actualitzar TinkerCAD si cal. | CE1, CE2 | Caixons SA2, regadora, sensor |
...
5. Presenta el repte: dissenyar i imprimir la reixa per al caixó de la SA2

> 💡 **L'alumnat que ja ha fet la SA2 estarà molt motivat** quan vegi que el producte va destinat al seu propi caixó. Aprofita aquesta motivació.
...
> **Marc**: Decret 107/2022 (LOMLOE, CV). Les CE i criteris d'avaluació que s'avaluen en aquesta SA són: **CE1** (1.1–1.4), **CE2** (2.1–2.5), **CE3** (3.1–3.5), **CE5** (5.1–5.4) i **CE6** (6.1, 6.2, 6.3, 6.5).

### 7.1 Distribució del pes avaluatiu

| CE | Competència | Pes | Instrument | Moment |
|----|------------|:---:|-----------|--------|
| **CE1** | Resolució de problemes | 15% | Rúbrica plànol + anàlisi req. · Peer review | S2 · S8 · S12 · S14 |
| **CE2** | Fabricació digital (3D) | 35% | Rúbrica model STL · Rúbrica impressió · Proves funcionals | S4–S8 · S11 · S12 |
| **CE3** | Comunicació tècnica | 15% | Rúbrica memòria · Rúbrica oral · Peer review | S8 · S13 · S14 |
| **CE5** | Eines digitals | 20% | Observació TinkerCAD/Cura · Checklist configuració | S4–S8 · S9–S10 · S13 |
| **CE6** | Sostenibilitat | 10% | Apartat sostenibilitat memòria · Pressupost | S13 lliurament · S14 oral |
| Actitud/Autonomia | — | 5% | Full d'observació docent | Continu |

> ⚠️ El fitxer STL exportat i la memòria tècnica són **obligatoris** per a superar la SA.

---

### 7.2 Rúbrica CE1 — Resolució de problemes (15%)
...
|---------|:-----------------:|:-------------:|:---------------:|:----------------:|
| **1.1** Identificació del problema | Anàlisi profunda de la necessitat de la reixa, requisits ben definits | Anàlisi adequada, algun aspecte menor | Identificació bàsica | No identifica o confon |
| **1.2** Solució (plànol + càlcul àrea) | 3 vistes, totes les cotes, àrea ≥40% calculada correctament | 3 vistes, cotes, càlcul present amb error menor | 2 vistes, cotes parcials | Plànol absent o incorrecte |
| **1.3** Planificació creativa | Gantt, rols i fitxa tècnica completa, valor per a la comunitat argumentat | Gantt + rols presents | Planificació bàsica | Absent o molt incompleta |
| **1.4** Gestió iterativa | Iteració documentada (problema→solució), taula disseny vs. real | Majoria documentada | Documentació parcial | Sense documentació |

</details>

### 7.3 Rúbrica CE2 — Fabricació digital (35%)
...
| Criteri | Excel·lent (9–10) | Notable (7–8) | Suficient (5–6) | Insuficient (<5) |
|---------|:-----------------:|:-------------:|:---------------:|:----------------:|
| **2.1** Qualitat del model i la peça | Reixa funcional, mesures ±0,5 mm, totes les proves superades | Funcional, mesures ±1 mm, majoria proves OK | Funcional amb defectes menors, ±2 mm | No funcional o no impresa |
| **2.2** Selecció de material i paràmetres | PLA justificat, taula paràmetres Cura completa i raonada | PLA correcte, paràmetres configurat amb justificació bàsica | Material correcte, paràmetres parcials | Material no justificat |
| **2.3** Destresa en CAD i FDM | TinkerCAD: booleanes, patró, connector i text correctes | Model correcte amb mínims errors | Model bàsic funcional | Model incorrecte o no exportable |
| **2.4** Ús correcte impressora | Monitoratge documentat, incidents resolts correctament | Monitoratge bàsic | Supervisió docent necessària | No monitorat |
| **2.5** Ús responsable del material | Estimació PLA (Cura), comparativa cost documentada | Estimació present, menció a memòria | Menció superficial | Absent |

</details>

### 7.4 Rúbrica CE3 — Comunicació tècnica (15%)
...
| Criteri | Excel·lent (9–10) | Notable (7–8) | Suficient (5–6) | Insuficient (<5) |
|---------|:-----------------:|:-------------:|:---------------:|:----------------:|
| **3.1** Vocabulari 3D i representació | Vocabulari STL/G-code/infill precís, plànol acotat correcte | Vocabulari adequat, algun error | Vocabulari bàsic | Vocabulari incorrecte |
| **3.2** Documentació digital | Memòria completa amb captures TinkerCAD/Cura comentades | Majoria d'apartats, captures presents | Memòria bàsica | Absent o molt incompleta |
| **3.3** Presentació oral | Clara, mostra el model i la reixa, gestió perfecta | Clara, adequada | Comprensible però poc estructurada | Confusa o molt breu |
| **3.4** Peer review i equip | Feedback constructiu (S8), comunicació assertiva | Bon feedback, petites mancances | Feedback bàsic | Absent o inadequat |
| **3.5** Expressió oral | Entonació, temps, vocabulari inclusiu perfectes | Expressió adequada | Expressió bàsica | Molt deficient |

</details>

### 7.5 Rúbrica CE5 — Eines digitals (20%)

<details>
<summary>Desplegar rúbrica CE5</summary>

| Criteri | Excel·lent (9–10) | Notable (7–8) | Suficient (5–6) | Insuficient (<5) |
|---------|:-----------------:|:-------------:|:---------------:|:----------------:|
| **5.1** Configuració d'eines | TinkerCAD i Cura configurats correctament i autònomament | Configuració correcta amb suport puntual | Configuració parcial, necessita guia | No configura o necessita suport constant |
| **5.2** Eficiència en l'ús | Model complet, STL net, G-code generat autònomament | Autònom amb mínims entrebancs | Autònom en les tasques principals | Necessita suport constant |
| **5.3** Ús ètic i responsable | Reflexió documentada sobre software lliure i ús responsable | Menció present a la memòria | Menció superficial | Absent |
| **5.4** Llicències i drets d'autoria | Llicències de TinkerCAD i Cura identificades i respectades | Llicències esmentades correctament | Esmentades parcialment | No tractades |

</details>

### 7.6 Rúbrica CE6 — Sostenibilitat (10%)
...
| Criteri | Excel·lent (9–10) | Notable (7–8) | Suficient (5–6) | Insuficient (<5) |
|---------|:-----------------:|:-------------:|:---------------:|:----------------:|
| **6.1** Sostenibilitat del disseny | Anàlisi PLA vs. PE/PP quantitativa + mesures concretes | Reflexió qualitativa sòlida | Menció breu | Absent |
| **6.2** Anàlisi processos productius | Comparativa documentada PLA (midó) vs. PE/PP (petroli) | Comparativa present | Menció bàsica | Absent |
| **6.3** Impacte social | Connexió hort–comunitat, STL publicat (coneixement obert) | Impacte social present | Menció superficial | No tractat |
| **6.5** Cicle de vida | Cost fabricació vs. compra + proposta fi de cicle PLA | Pressupost + fi de cicle mencionat | Pressupost parcial | Absent |

</details>

### 7.7 Fitxa de peer review (S8)

```markdown
## Fitxa Peer Review TinkerCAD — Sessió 8

Grup revisor: ___________  Grup revisat: ___________  Data: ___

| Criteri (CE2/CE5) | Valoració (1–4) | Observació |
|-------------------|:---------------:|------------|
| Dimensions aproximades correctes | | |
| Forats hexagonals presents i regulars (CE2) | | |
| Àrea de drenatge ≥ 40% (valor: ___%) | | |
| Connector present i funcional (CE2) | | |
| Configuració TinkerCAD adequada (CE5) | | |

Suggeriment de millora principal (CE1.4):
> _______________________________________________
```

### 7.8 Full d'observació (per al docent)

```markdown
## Full d'observació de sessió — SA3

Sessió: ___  Data: ___

| Alumne/a | CE5 TinkerCAD (1–4) | CE2 Tècnica (1–4) | Actitud (1–4) | Obs. |
|----------|:-------------------:|:-----------------:|:-------------:|------|
|          |                     |                   |               |      |
|          |                     |                   |               |      |
```
...
Repte C: Suport per al sensor integrat
  ...
  → Ha d'encaixar en el passacable del caixó de la SA2
...
| **Biologia / CCNN** | Porositat del sòl, drenatge òptim per a les arrels, SA2 compost | S12 |
...
├── GUIA_DOCENT_SA3_Disseny3D.md           ← Aquesta guia
