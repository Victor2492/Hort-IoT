...
* **S17 - S22: Operadors i estructures de control (Estació integrada) (Individual - 6 sessions: 330 min)**
    ...
    * *Programació d'Algorismes de Condicions Complexes:*
        ...
        * **Condició de Reg Crític:** Si la humitat del sòl pateix una davallada forta caient per davall del llindar del 15%, s'activarà directament el reg d'emergència com a mesura prioritària d'actuació, saltant-se les restriccions d'irradiància anteriors per assegurar la planta.
...
## 4. COMPETÈNCIES ESPECÍFIQUES I INSTRUMENTS D'AVALUACIÓ
...
|---|---|---|---|---|---|---|
| **1.4 Gestió del projecte** | Gestionar creativament el desenvolupament d'un projecte seguint un procés iteratiu de validació, des de la ideació fins a la difusió | L'alumnat gestiona el temps i els recursos de forma autònoma i eficient. Valida el funcionament en cada fase, corregeix errors de forma iterativa i entrega la pràctica completa i ben documentada dins del termini. | L'alumnat gestiona adequadament el desenvolupament de la pràctica. Valida el funcionament del circuit i del codi, corregeix la majoria d'errors i entrega dins del termini amb documentació suficient. | L'alumnat completa la pràctica parcialment. La gestió del temps és irregular i la validació és superficial. Alguns errors queden sense corregir i la documentació és incompleta. | L'alumnat mostra dificultats per gestionar el desenvolupament de la pràctica. La validació és absent o incorrecta. L'entrega és molt incompleta o fora de termini sense justificació. | Treball no presentat. |
...
| **3.1 Comunicació tècnica** | Comunicar i interpretar informació amb el vocabulari tècnic, els símbols i els esquemes de sistemes tecnològics apropiats | L'alumnat emplena la taula de components amb total precisió (component, cable, pin, nota), usa vocabulari tècnic correcte i precís (ànode, càtode, pin digital/analògic, ADC, histèresi…) i respon les preguntes de reflexió amb terminologia específica i ben argumentada. | L'alumnat emplena correctament la taula de components i usa vocabulari tècnic adequat en la majoria de les respostes de reflexió. Algun terme incorrecte o imprecís que no afecta la comprensió global. | L'alumnat emplena la taula de components amb errors o omissions puntuals. El vocabulari tècnic és parcialment correcte: barreja termes tècnics amb descripcions col·loquials o inexactes. | L'alumnat emplena la taula de components de forma incompleta o incorrecta. El vocabulari usat és majoritàriament col·loquial o incorrecte. Les respostes de reflexió no fan ús de terminologia tècnica. | Treball no presentat. |
| **3.3 Presentació i difusió de la solució** | Presentar i difondre les propostes o solucions tecnològiques de manera efectiva | L'alumnat entrega l'URL del projecte TinkerCAD correctament nomenat (`Hort_NomCognom_PX`), el projecte és accessible i completament funcional, i les respostes de reflexió estan redactades de forma clara, completa i ben estructurada. | L'alumnat entrega l'URL del projecte TinkerCAD amb la nomenclatura correcta i el projecte és funcional. Les respostes de reflexió són clares i cobreixen els aspectes principals demanats. | L'alumnat entrega l'URL però la nomenclatura del projecte és incorrecta o incompleta. El projecte és parcialment funcional. Les respostes de reflexió són superficials o incompletes. | L'alumnat entrega l'URL però el projecte no és accessible, no funciona o no correspon a la pràctica demanada. Les respostes de reflexió són absents o no responen al que es demana. | Treball no presentat. |
...
| **5.1 Configuració d'eines digitals** | Configurar aplicacions i eines digitals (TinkerCAD) en funció dels reptes tecnològics plantejats | L'alumnat configura TinkerCAD amb total autonomia: crea el projecte, afegeix i parametritza tots els components, configura correctament cada pin (mode, tipus de senyal) i gestiona l'entorn de simulació sense ajuda. | L'alumnat configura TinkerCAD correctament per a la pràctica: crea el projecte, afegeix els components necessaris i configura els pins adequadament. Necessita suport puntual en algun aspecte. | L'alumnat configura TinkerCAD parcialment. Comet errors en la configuració de pins (entrada/eixida, digital/analògic) o en la parametrització d'algun component que cal corregir. | L'alumnat presenta dificultats importants per configurar TinkerCAD. Errors reitarats en la configuració dels components o dels pins impedeixen avançar en la pràctica. | Treball no presentat. |
