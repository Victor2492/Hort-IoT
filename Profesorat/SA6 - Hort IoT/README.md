...
| **1.2 Solució eficient i innovadora** | Idear solucions tecnològiques eficients i innovadores considerant les necessitats del projecte | La solució és innovadora i eficient. L'alumnat ha anat més enllà de l'enunciat: ha afegit funcionalitats, optimitzat el codi o proposat millores justificades per a l'aplicació real. | La solució és funcional i eficient. S'observen decisions raonades (p.ex. ús d'histèresi, ajust de temps). La solució connecta clarament amb la necessitat real del projecte Hort. | La solució aborda la necessitat però de forma bàsica, sense considerar casos d'ús reals ni optimitzacions. Segueix l'enunciat al peu de la lletra sense aportació pròpia. | La solució no aborda la necessitat plantejada o reprodueix l'exemple sense cap adaptació. | Treball no presentat. |
