...
Com que ja domineu les eines bàsiques de tall i lligam, agruparem aquestes quatre sessions per a dur a terme el gruix de la feina al taller. Aquest és el moment de la veritat: el vostre esquelet de canyes està agafant forma, però un edifici no està complet sense la seua pell i el seu sistema nerviós.
